...
public class UserReadingForm extends JDialog {
    ...
    private UsuarioDAO userDAO; // Instancia de UserDAO para realizar operaciones de base de datos de usuarios.
    ...
    public UserReadingForm(MainForm mainForm) {
        ...
        btnCreate.addActionListener(s -> {
            ...
            UserWriteForm userWriteForm = new UserWriteForm(this.mainForm, CUD.CREATE, new Usuario());
    ...
    public void createTable(ArrayList<Usuario> users) {
        ...
        for (int i = 0; i < users.size(); i++) {
            ...
            model.setValueAt(user.getIdUsuario(), i, 0);
            ...
            // Establece el valor del Nivel de usuario (probablemente obtenido a través de un método 'NivelUsuarioName()')
            // en la celda correspondiente de la fila actual (columna 4).
            model.setValueAt(user.getNivelUsuarioName(), i, 4);
    ...
    private Usuario getUserFromTableRow() {
        Usuario user = null; // Inicializa la variable user a null.
        try {
