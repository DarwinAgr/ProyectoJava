...
import Esfe.Dominio.Usuario; // Importa la clase User, que probablemente representa un usuario en el sistema.
import Esfe.Persistencia.UsuarioDAO; // Importa la interfaz o clase UserDAO, que define o implementa el acceso a datos para la entidad User.
